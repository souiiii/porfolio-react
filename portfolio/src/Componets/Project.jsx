...
function Project({ lr, name, pic, children }) {
  ...
  useEffect(function () {
    const h1 = new SplitType(heading.current, {
      types: "chars",
    });
    const t = gsap.timeline({
      scrollTrigger: {
    ...
    t.fromTo(
      h1.chars,
      { x: "-100%", opacity: 0 },
      { x: "50%", opacity: 1, ease: "power1.inOut" }
    );
    ...
    t2.to(h1.chars, { x: "-100%", opacity: 0, ease: "power1.inOut" });
  }, []);
  useEffect(function () {
    const d = new SplitType(desc.current, {
      types: "words",
    });
    const t2 = gsap.timeline({
      scrollTrigger: {
    ...
    t2.fromTo(
      d.words,
      { x: "100%", opacity: 0 },
      { x: 0, opacity: 1, duration: 0.3, ease: "power1.inOut" }
    );
        ...
        {lr === 1 ? (
          <div ref={content} className={styles.content}>
            ...
            >
              ...
              >
                <path
                  d="M630 11716 c8 -7 53 -26 100 -41 282 -91 811 -295 955 -368 50 -25
